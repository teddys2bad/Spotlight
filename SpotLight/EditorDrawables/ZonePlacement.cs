...
namespace Spotlight.EditorDrawables
{
    ...
    public class ZonePlacement : SingleObject
    {
        ...
        public ZonePlacement(Vector3 pos, Vector3 rot, Layer layer, SM3DWorldZone zone, string zoneID = "")
            : base(pos)
        {
            Rotation = rot;
        ...
        public void Save(DictionaryNode objNode, int zoneID)
        {
            ...
            {
                objNode.AddDynamicValue("Id", ZoneID);
            }
            objNode.AddDynamicValue("Id", "zone" + zoneID);
        ...
        public new class PropertyProvider : IObjectUIContainer
        {
            ...
            public void DoUI(IObjectUIControl control)
            {
                ...
                placement.ZoneID = control.TextInput(placement.ZoneID, "Id");
